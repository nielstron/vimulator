/*
 * VimulatorCommandLine.java - Vimulator command entry field Copyright (C) 2002 mike dillon
 *
...
public class VimulatorCommandLine extends JPanel implements DocumentListener, ActionListener {
    ...
    private void processExCommand(String expr) {
        try {
            ...
            setStatus(jEdit.getProperty("vimulator.msg.bad-ex-command", args));
        }
    }
