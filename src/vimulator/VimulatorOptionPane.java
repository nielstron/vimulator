/*
 * VimulatorOptionPane.java
 * Copyright &copy; 2001 mike dillon
 *
...
public class VimulatorOptionPane extends AbstractOptionPane
{
	...
	protected void _init()
	{
		...
		enableCheckBox = new JCheckBox(jEdit.getProperty(
			"options.vimulator.enable"));
		enableCheckBox.setSelected(jEdit.getBooleanProperty(
	...
	{
		jEdit.setBooleanProperty("vimulator.enabled",
